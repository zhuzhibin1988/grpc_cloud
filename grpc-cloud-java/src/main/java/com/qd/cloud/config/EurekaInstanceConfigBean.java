...
public class EurekaInstanceConfigBean implements EurekaInstanceConfig {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(appname, appGroupName,
    ...
    public String toString() {
        return new StringBuilder("EurekaInstanceConfigBean{").append("appname='").append(appname).append("', ")
                ...
                .append(Arrays.toString(defaultAddressResolutionOrder)).append(", ").append("}")
                .toString();
    }
}
